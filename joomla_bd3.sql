...
-- Tiempo de generación: 05-03-2019 a las 02:50:59
...
--
-- Base de datos: `joomla_bd3`
--

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `lv2ld_action_logs`
--

DROP TABLE IF EXISTS `lv2ld_action_logs`;
CREATE TABLE IF NOT EXISTS `lv2ld_action_logs` (
...
--
-- Volcado de datos para la tabla `lv2ld_action_logs`
--

INSERT INTO `lv2ld_action_logs` (`id`, `message_language_key`, `message`, `log_date`, `extension`, `user_id`, `item_id`, `ip_address`) VALUES
(1, 'PLG_ACTIONLOG_JOOMLA_USER_LOGGED_IN', '{\"action\":\"login\",\"userid\":\"288\",\"username\":\"veronica\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=288\",\"app\":\"PLG_ACTIONLOG_JOOMLA_APPLICATION_ADMINISTRATOR\"}', '2019-03-04 20:17:10', 'com_users', 288, 0, 'COM_ACTIONLOGS_DISABLED'),
(2, 'PLG_ACTIONLOG_JOOMLA_USER_LOGGED_IN', '{\"action\":\"login\",\"userid\":\"288\",\"username\":\"veronica\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=288\",\"app\":\"PLG_ACTIONLOG_JOOMLA_APPLICATION_ADMINISTRATOR\"}', '2019-03-04 20:33:45', 'com_users', 288, 0, 'COM_ACTIONLOGS_DISABLED'),
(3, 'PLG_ACTIONLOG_JOOMLA_USER_LOGGED_IN', '{\"action\":\"login\",\"userid\":\"288\",\"username\":\"veronica\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=288\",\"app\":\"PLG_ACTIONLOG_JOOMLA_APPLICATION_SITE\"}', '2019-03-04 20:36:24', 'com_users', 288, 0, 'COM_ACTIONLOGS_DISABLED'),
(4, 'PLG_ACTIONLOG_JOOMLA_USER_LOGGED_OUT', '{\"action\":\"logout\",\"id\":\"288\",\"userid\":\"288\",\"username\":\"veronica\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=288\",\"app\":\"PLG_ACTIONLOG_JOOMLA_APPLICATION_SITE\"}', '2019-03-04 20:37:07', 'com_users', 288, 288, 'COM_ACTIONLOGS_DISABLED'),
(5, 'PLG_SYSTEM_ACTIONLOGS_CONTENT_ADDED', '{\"action\":\"add\",\"type\":\"PLG_ACTIONLOG_JOOMLA_TYPE_ARTICLE\",\"id\":1,\"title\":\"noticias upv\",\"itemlink\":\"index.php?option=com_content&task=article.edit&id=1\",\"userid\":\"288\",\"username\":\"veronica\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=288\"}', '2019-03-04 20:38:26', 'com_content.article', 288, 1, 'COM_ACTIONLOGS_DISABLED'),
(6, 'PLG_SYSTEM_ACTIONLOGS_CONTENT_UPDATED', '{\"action\":\"update\",\"type\":\"PLG_ACTIONLOG_JOOMLA_TYPE_ARTICLE\",\"id\":1,\"title\":\"noticias upv\",\"itemlink\":\"index.php?option=com_content&task=article.edit&id=1\",\"userid\":\"288\",\"username\":\"veronica\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=288\"}', '2019-03-04 20:39:14', 'com_content.article', 288, 1, 'COM_ACTIONLOGS_DISABLED'),
(7, 'PLG_ACTIONLOG_JOOMLA_USER_CHECKIN', '{\"action\":\"checkin\",\"type\":\"PLG_ACTIONLOG_JOOMLA_TYPE_USER\",\"id\":\"288\",\"title\":\"veronica\",\"itemlink\":\"index.php?option=com_users&task=user.edit&id=288\",\"userid\":\"288\",\"username\":\"veronica\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=288\",\"table\":\"#__content\"}', '2019-03-04 20:39:14', 'com_content', 288, 288, 'COM_ACTIONLOGS_DISABLED'),
(8, 'PLG_ACTIONLOG_JOOMLA_USER_LOGGED_IN', '{\"action\":\"login\",\"userid\":\"288\",\"username\":\"veronica\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=288\",\"app\":\"PLG_ACTIONLOG_JOOMLA_APPLICATION_SITE\"}', '2019-03-04 20:41:05', 'com_users', 288, 0, 'COM_ACTIONLOGS_DISABLED'),
(9, 'PLG_SYSTEM_ACTIONLOGS_CONTENT_ADDED', '{\"action\":\"add\",\"type\":\"PLG_ACTIONLOG_JOOMLA_TYPE_ARTICLE\",\"id\":2,\"title\":\"noticia 1 de la upv\",\"itemlink\":\"index.php?option=com_content&task=article.edit&id=2\",\"userid\":\"288\",\"username\":\"veronica\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=288\"}', '2019-03-04 20:42:12', 'com_content.article', 288, 2, 'COM_ACTIONLOGS_DISABLED'),
(10, 'PLG_SYSTEM_ACTIONLOGS_CONTENT_ADDED', '{\"action\":\"add\",\"type\":\"PLG_ACTIONLOG_JOOMLA_TYPE_MENU_ITEM\",\"id\":102,\"title\":\"Noticia 1\",\"itemlink\":\"index.php?option=com_menus&task=item.edit&id=102\",\"userid\":\"288\",\"username\":\"veronica\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=288\"}', '2019-03-04 20:44:50', 'com_menus.item', 288, 102, 'COM_ACTIONLOGS_DISABLED'),
(11, 'PLG_ACTIONLOG_JOOMLA_USER_LOGGED_IN', '{\"action\":\"login\",\"userid\":\"288\",\"username\":\"veronica\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=288\",\"app\":\"PLG_ACTIONLOG_JOOMLA_APPLICATION_ADMINISTRATOR\"}', '2019-03-05 02:39:45', 'com_users', 288, 0, 'COM_ACTIONLOGS_DISABLED');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `lv2ld_action_logs_extensions`
--

DROP TABLE IF EXISTS `lv2ld_action_logs_extensions`;
CREATE TABLE IF NOT EXISTS `lv2ld_action_logs_extensions` (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
...
--
-- Volcado de datos para la tabla `lv2ld_action_logs_extensions`
--

INSERT INTO `lv2ld_action_logs_extensions` (`id`, `extension`) VALUES
(1, 'com_banners'),
(2, 'com_cache'),
(3, 'com_categories'),
(4, 'com_config'),
...
--
-- Estructura de tabla para la tabla `lv2ld_action_logs_users`
--

DROP TABLE IF EXISTS `lv2ld_action_logs_users`;
CREATE TABLE IF NOT EXISTS `lv2ld_action_logs_users` (
...
--
-- Estructura de tabla para la tabla `lv2ld_action_log_config`
--

DROP TABLE IF EXISTS `lv2ld_action_log_config`;
CREATE TABLE IF NOT EXISTS `lv2ld_action_log_config` (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
...
--
-- Volcado de datos para la tabla `lv2ld_action_log_config`
--

INSERT INTO `lv2ld_action_log_config` (`id`, `type_title`, `type_alias`, `id_holder`, `title_holder`, `table_name`, `text_prefix`) VALUES
...
--
-- Estructura de tabla para la tabla `lv2ld_assets`
--

DROP TABLE IF EXISTS `lv2ld_assets`;
CREATE TABLE IF NOT EXISTS `lv2ld_assets` (
...
--
-- Volcado de datos para la tabla `lv2ld_assets`
--

INSERT INTO `lv2ld_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
...
(60, 27, 19, 20, 3, 'com_content.article.1', 'noticias upv', '{}'),
(61, 27, 21, 22, 3, 'com_content.article.2', 'noticia 1 de la upv', '{}');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `lv2ld_associations`
--

DROP TABLE IF EXISTS `lv2ld_associations`;
CREATE TABLE IF NOT EXISTS `lv2ld_associations` (
...
--
-- Estructura de tabla para la tabla `lv2ld_banners`
--

DROP TABLE IF EXISTS `lv2ld_banners`;
CREATE TABLE IF NOT EXISTS `lv2ld_banners` (
...
--
-- Estructura de tabla para la tabla `lv2ld_banner_clients`
--

DROP TABLE IF EXISTS `lv2ld_banner_clients`;
CREATE TABLE IF NOT EXISTS `lv2ld_banner_clients` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
--
-- Estructura de tabla para la tabla `lv2ld_banner_tracks`
--

DROP TABLE IF EXISTS `lv2ld_banner_tracks`;
CREATE TABLE IF NOT EXISTS `lv2ld_banner_tracks` (
...
--
-- Estructura de tabla para la tabla `lv2ld_categories`
--

DROP TABLE IF EXISTS `lv2ld_categories`;
CREATE TABLE IF NOT EXISTS `lv2ld_categories` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Volcado de datos para la tabla `lv2ld_categories`
--

INSERT INTO `lv2ld_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`, `version`) VALUES
(1, 0, 0, 0, 11, 0, '', 'system', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{}', '', '', '{}', 288, '2019-02-28 20:24:04', 0, '0000-00-00 00:00:00', 0, '*', 1),
(2, 27, 1, 1, 2, 1, 'uncategorised', 'com_content', 'Uncategorised', 'uncategorised', '', '', 1, 288, '2019-03-04 20:42:29', 1, '{\"category_layout\":\"\",\"image\":\"\"}', '', '', '{\"author\":\"\",\"robots\":\"\"}', 288, '2019-02-28 20:24:04', 0, '0000-00-00 00:00:00', 0, '*', 1),
(3, 28, 1, 3, 4, 1, 'uncategorised', 'com_banners', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{\"category_layout\":\"\",\"image\":\"\"}', '', '', '{\"author\":\"\",\"robots\":\"\"}', 288, '2019-02-28 20:24:04', 0, '0000-00-00 00:00:00', 0, '*', 1),
(4, 29, 1, 5, 6, 1, 'uncategorised', 'com_contact', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{\"category_layout\":\"\",\"image\":\"\"}', '', '', '{\"author\":\"\",\"robots\":\"\"}', 288, '2019-02-28 20:24:04', 0, '0000-00-00 00:00:00', 0, '*', 1),
(5, 30, 1, 7, 8, 1, 'uncategorised', 'com_newsfeeds', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{\"category_layout\":\"\",\"image\":\"\"}', '', '', '{\"author\":\"\",\"robots\":\"\"}', 288, '2019-02-28 20:24:04', 0, '0000-00-00 00:00:00', 0, '*', 1),
(7, 32, 1, 9, 10, 1, 'uncategorised', 'com_users', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{\"category_layout\":\"\",\"image\":\"\"}', '', '', '{\"author\":\"\",\"robots\":\"\"}', 288, '2019-02-28 20:24:04', 0, '0000-00-00 00:00:00', 0, '*', 1);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `lv2ld_contact_details`
--

DROP TABLE IF EXISTS `lv2ld_contact_details`;
CREATE TABLE IF NOT EXISTS `lv2ld_contact_details` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Estructura de tabla para la tabla `lv2ld_content`
--

DROP TABLE IF EXISTS `lv2ld_content`;
CREATE TABLE IF NOT EXISTS `lv2ld_content` (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `asset_id` int(10) UNSIGNED NOT NULL DEFAULT '0' COMMENT 'FK to the #__assets table.',
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `alias` varchar(400) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '',
...
--
-- Volcado de datos para la tabla `lv2ld_content`
--

INSERT INTO `lv2ld_content` (`id`, `asset_id`, `title`, `alias`, `introtext`, `fulltext`, `state`, `catid`, `created`, `created_by`, `created_by_alias`, `modified`, `modified_by`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `images`, `urls`, `attribs`, `version`, `ordering`, `metakey`, `metadesc`, `access`, `hits`, `metadata`, `featured`, `language`, `xreference`, `note`) VALUES
(1, 60, 'noticias upv', 'noticias-upv', '<p>catalogo de noticias universitarias</p>', '', 1, 2, '2019-03-04 20:38:26', 288, '', '2019-03-04 20:39:14', 288, 0, '0000-00-00 00:00:00', '2019-03-04 20:38:26', '0000-00-00 00:00:00', '{\"image_intro\":\"\",\"float_intro\":\"\",\"image_intro_alt\":\"\",\"image_intro_caption\":\"\",\"image_fulltext\":\"\",\"float_fulltext\":\"\",\"image_fulltext_alt\":\"\",\"image_fulltext_caption\":\"\"}', '{\"urla\":false,\"urlatext\":\"\",\"targeta\":\"\",\"urlb\":false,\"urlbtext\":\"\",\"targetb\":\"\",\"urlc\":false,\"urlctext\":\"\",\"targetc\":\"\"}', '{\"article_layout\":\"\",\"show_title\":\"\",\"link_titles\":\"\",\"show_tags\":\"\",\"show_intro\":\"\",\"info_block_position\":\"\",\"info_block_show_title\":\"\",\"show_category\":\"\",\"link_category\":\"\",\"show_parent_category\":\"\",\"link_parent_category\":\"\",\"show_associations\":\"\",\"show_author\":\"\",\"link_author\":\"\",\"show_create_date\":\"\",\"show_modify_date\":\"\",\"show_publish_date\":\"\",\"show_item_navigation\":\"\",\"show_icons\":\"\",\"show_print_icon\":\"\",\"show_email_icon\":\"\",\"show_vote\":\"\",\"show_hits\":\"\",\"show_noauth\":\"\",\"urls_position\":\"\",\"alternative_readmore\":\"\",\"article_page_title\":\"\",\"show_publishing_options\":\"\",\"show_article_options\":\"\",\"show_urls_images_backend\":\"\",\"show_urls_images_frontend\":\"\"}', 2, 1, '', '', 1, 0, '{\"robots\":\"\",\"author\":\"\",\"rights\":\"\",\"xreference\":\"\"}', 0, '*', '', ''),
(2, 61, 'noticia 1 de la upv', 'noticia-1-de-la-upv', '<p><img src=\"images/banners/shop-ad-books.jpg\" alt=\"\" /></p>', '', 1, 2, '2019-03-04 20:42:12', 288, '', '2019-03-04 20:42:12', 0, 0, '0000-00-00 00:00:00', '2019-03-04 20:42:12', '0000-00-00 00:00:00', '{\"image_intro\":\"\",\"float_intro\":\"\",\"image_intro_alt\":\"\",\"image_intro_caption\":\"\",\"image_fulltext\":\"\",\"float_fulltext\":\"\",\"image_fulltext_alt\":\"\",\"image_fulltext_caption\":\"\"}', '{\"urla\":false,\"urlatext\":\"\",\"targeta\":\"\",\"urlb\":false,\"urlbtext\":\"\",\"targetb\":\"\",\"urlc\":false,\"urlctext\":\"\",\"targetc\":\"\"}', '{\"article_layout\":\"\",\"show_title\":\"\",\"link_titles\":\"\",\"show_tags\":\"\",\"show_intro\":\"\",\"info_block_position\":\"\",\"info_block_show_title\":\"\",\"show_category\":\"\",\"link_category\":\"\",\"show_parent_category\":\"\",\"link_parent_category\":\"\",\"show_associations\":\"\",\"show_author\":\"\",\"link_author\":\"\",\"show_create_date\":\"\",\"show_modify_date\":\"\",\"show_publish_date\":\"\",\"show_item_navigation\":\"\",\"show_icons\":\"\",\"show_print_icon\":\"\",\"show_email_icon\":\"\",\"show_vote\":\"\",\"show_hits\":\"\",\"show_noauth\":\"\",\"urls_position\":\"\",\"alternative_readmore\":\"\",\"article_page_title\":\"\",\"show_publishing_options\":\"\",\"show_article_options\":\"\",\"show_urls_images_backend\":\"\",\"show_urls_images_frontend\":\"\"}', 1, 0, '', '', 1, 0, '{\"robots\":\"\",\"author\":\"\",\"rights\":\"\",\"xreference\":\"\"}', 0, '*', '', '');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `lv2ld_contentitem_tag_map`
--

DROP TABLE IF EXISTS `lv2ld_contentitem_tag_map`;
CREATE TABLE IF NOT EXISTS `lv2ld_contentitem_tag_map` (
  `type_alias` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
--
-- Estructura de tabla para la tabla `lv2ld_content_frontpage`
--

DROP TABLE IF EXISTS `lv2ld_content_frontpage`;
CREATE TABLE IF NOT EXISTS `lv2ld_content_frontpage` (
...
--
-- Estructura de tabla para la tabla `lv2ld_content_rating`
--

DROP TABLE IF EXISTS `lv2ld_content_rating`;
CREATE TABLE IF NOT EXISTS `lv2ld_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
...
--
-- Estructura de tabla para la tabla `lv2ld_content_types`
--

DROP TABLE IF EXISTS `lv2ld_content_types`;
CREATE TABLE IF NOT EXISTS `lv2ld_content_types` (
...
--
-- Volcado de datos para la tabla `lv2ld_content_types`
--

INSERT INTO `lv2ld_content_types` (`type_id`, `type_title`, `type_alias`, `table`, `rules`, `field_mappings`, `router`, `content_history_options`) VALUES
...
--
-- Estructura de tabla para la tabla `lv2ld_core_log_searches`
--

DROP TABLE IF EXISTS `lv2ld_core_log_searches`;
CREATE TABLE IF NOT EXISTS `lv2ld_core_log_searches` (
...
--
-- Estructura de tabla para la tabla `lv2ld_extensions`
--

DROP TABLE IF EXISTS `lv2ld_extensions`;
CREATE TABLE IF NOT EXISTS `lv2ld_extensions` (
...
--
-- Volcado de datos para la tabla `lv2ld_extensions`
--

INSERT INTO `lv2ld_extensions` (`extension_id`, `package_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
...
(103, 0, 'LIB_JOOMLA', 'library', 'joomla', '', 0, 1, 1, 1, '{\"name\":\"LIB_JOOMLA\",\"type\":\"library\",\"creationDate\":\"2008\",\"author\":\"Joomla! Project\",\"copyright\":\"Copyright (C) 2005 - 2019 Open Source Matters. All rights reserved.\",\"authorEmail\":\"admin@joomla.org\",\"authorUrl\":\"https:\\/\\/www.joomla.org\",\"version\":\"13.1\",\"description\":\"LIB_JOOMLA_XML_DESCRIPTION\",\"group\":\"\",\"filename\":\"joomla\"}', '{\"mediaversion\":\"b68f732acfdab684a915dc47f1628f5d\"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(452, 0, 'plg_system_updatenotification', 'plugin', 'updatenotification', 'system', 0, 1, 1, 0, '{\"name\":\"plg_system_updatenotification\",\"type\":\"plugin\",\"creationDate\":\"May 2015\",\"author\":\"Joomla! Project\",\"copyright\":\"Copyright (C) 2005 - 2019 Open Source Matters. All rights reserved.\",\"authorEmail\":\"admin@joomla.org\",\"authorUrl\":\"www.joomla.org\",\"version\":\"3.5.0\",\"description\":\"PLG_SYSTEM_UPDATENOTIFICATION_XML_DESCRIPTION\",\"group\":\"\",\"filename\":\"updatenotification\"}', '{\"lastrun\":1551753569}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
--
-- Estructura de tabla para la tabla `lv2ld_fields`
--

DROP TABLE IF EXISTS `lv2ld_fields`;
CREATE TABLE IF NOT EXISTS `lv2ld_fields` (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
...
--
-- Estructura de tabla para la tabla `lv2ld_fields_categories`
--

DROP TABLE IF EXISTS `lv2ld_fields_categories`;
CREATE TABLE IF NOT EXISTS `lv2ld_fields_categories` (
...
--
-- Estructura de tabla para la tabla `lv2ld_fields_groups`
--

DROP TABLE IF EXISTS `lv2ld_fields_groups`;
CREATE TABLE IF NOT EXISTS `lv2ld_fields_groups` (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `asset_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `context` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
--
-- Estructura de tabla para la tabla `lv2ld_fields_values`
--

DROP TABLE IF EXISTS `lv2ld_fields_values`;
CREATE TABLE IF NOT EXISTS `lv2ld_fields_values` (
...
--
-- Estructura de tabla para la tabla `lv2ld_finder_filters`
--

DROP TABLE IF EXISTS `lv2ld_finder_filters`;
CREATE TABLE IF NOT EXISTS `lv2ld_finder_filters` (
...
--
-- Estructura de tabla para la tabla `lv2ld_finder_links`
--

DROP TABLE IF EXISTS `lv2ld_finder_links`;
CREATE TABLE IF NOT EXISTS `lv2ld_finder_links` (
...
--
-- Estructura de tabla para la tabla `lv2ld_finder_links_terms0`
--

DROP TABLE IF EXISTS `lv2ld_finder_links_terms0`;
CREATE TABLE IF NOT EXISTS `lv2ld_finder_links_terms0` (
...
--
-- Estructura de tabla para la tabla `lv2ld_finder_links_terms1`
--

DROP TABLE IF EXISTS `lv2ld_finder_links_terms1`;
CREATE TABLE IF NOT EXISTS `lv2ld_finder_links_terms1` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Estructura de tabla para la tabla `lv2ld_finder_links_terms2`
--

DROP TABLE IF EXISTS `lv2ld_finder_links_terms2`;
CREATE TABLE IF NOT EXISTS `lv2ld_finder_links_terms2` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Estructura de tabla para la tabla `lv2ld_finder_links_terms3`
--

DROP TABLE IF EXISTS `lv2ld_finder_links_terms3`;
CREATE TABLE IF NOT EXISTS `lv2ld_finder_links_terms3` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Estructura de tabla para la tabla `lv2ld_finder_links_terms4`
--

DROP TABLE IF EXISTS `lv2ld_finder_links_terms4`;
CREATE TABLE IF NOT EXISTS `lv2ld_finder_links_terms4` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Estructura de tabla para la tabla `lv2ld_finder_links_terms5`
--

DROP TABLE IF EXISTS `lv2ld_finder_links_terms5`;
CREATE TABLE IF NOT EXISTS `lv2ld_finder_links_terms5` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Estructura de tabla para la tabla `lv2ld_finder_links_terms6`
--

DROP TABLE IF EXISTS `lv2ld_finder_links_terms6`;
CREATE TABLE IF NOT EXISTS `lv2ld_finder_links_terms6` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Estructura de tabla para la tabla `lv2ld_finder_links_terms7`
--

DROP TABLE IF EXISTS `lv2ld_finder_links_terms7`;
CREATE TABLE IF NOT EXISTS `lv2ld_finder_links_terms7` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Estructura de tabla para la tabla `lv2ld_finder_links_terms8`
--

DROP TABLE IF EXISTS `lv2ld_finder_links_terms8`;
CREATE TABLE IF NOT EXISTS `lv2ld_finder_links_terms8` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Estructura de tabla para la tabla `lv2ld_finder_links_terms9`
--

DROP TABLE IF EXISTS `lv2ld_finder_links_terms9`;
CREATE TABLE IF NOT EXISTS `lv2ld_finder_links_terms9` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Estructura de tabla para la tabla `lv2ld_finder_links_termsa`
--

DROP TABLE IF EXISTS `lv2ld_finder_links_termsa`;
CREATE TABLE IF NOT EXISTS `lv2ld_finder_links_termsa` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Estructura de tabla para la tabla `lv2ld_finder_links_termsb`
--

DROP TABLE IF EXISTS `lv2ld_finder_links_termsb`;
CREATE TABLE IF NOT EXISTS `lv2ld_finder_links_termsb` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Estructura de tabla para la tabla `lv2ld_finder_links_termsc`
--

DROP TABLE IF EXISTS `lv2ld_finder_links_termsc`;
CREATE TABLE IF NOT EXISTS `lv2ld_finder_links_termsc` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Estructura de tabla para la tabla `lv2ld_finder_links_termsd`
--

DROP TABLE IF EXISTS `lv2ld_finder_links_termsd`;
CREATE TABLE IF NOT EXISTS `lv2ld_finder_links_termsd` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Estructura de tabla para la tabla `lv2ld_finder_links_termse`
--

DROP TABLE IF EXISTS `lv2ld_finder_links_termse`;
CREATE TABLE IF NOT EXISTS `lv2ld_finder_links_termse` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Estructura de tabla para la tabla `lv2ld_finder_links_termsf`
--

DROP TABLE IF EXISTS `lv2ld_finder_links_termsf`;
CREATE TABLE IF NOT EXISTS `lv2ld_finder_links_termsf` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Estructura de tabla para la tabla `lv2ld_finder_taxonomy`
--

DROP TABLE IF EXISTS `lv2ld_finder_taxonomy`;
CREATE TABLE IF NOT EXISTS `lv2ld_finder_taxonomy` (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
...
--
-- Volcado de datos para la tabla `lv2ld_finder_taxonomy`
--

INSERT INTO `lv2ld_finder_taxonomy` (`id`, `parent_id`, `title`, `state`, `access`, `ordering`) VALUES
(1, 0, 'ROOT', 0, 0, 0);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `lv2ld_finder_taxonomy_map`
--

DROP TABLE IF EXISTS `lv2ld_finder_taxonomy_map`;
CREATE TABLE IF NOT EXISTS `lv2ld_finder_taxonomy_map` (
  `link_id` int(10) UNSIGNED NOT NULL,
...
--
-- Estructura de tabla para la tabla `lv2ld_finder_terms`
--

DROP TABLE IF EXISTS `lv2ld_finder_terms`;
CREATE TABLE IF NOT EXISTS `lv2ld_finder_terms` (
...
--
-- Estructura de tabla para la tabla `lv2ld_finder_terms_common`
--

DROP TABLE IF EXISTS `lv2ld_finder_terms_common`;
CREATE TABLE IF NOT EXISTS `lv2ld_finder_terms_common` (
  `term` varchar(75) NOT NULL,
...
--
-- Volcado de datos para la tabla `lv2ld_finder_terms_common`
--

INSERT INTO `lv2ld_finder_terms_common` (`term`, `language`) VALUES
('a', 'en'),
('about', 'en'),
('after', 'en'),
('ago', 'en'),
...
--
-- Estructura de tabla para la tabla `lv2ld_finder_tokens`
--

DROP TABLE IF EXISTS `lv2ld_finder_tokens`;
CREATE TABLE IF NOT EXISTS `lv2ld_finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) UNSIGNED NOT NULL DEFAULT '0',
  `phrase` tinyint(1) UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Estructura de tabla para la tabla `lv2ld_finder_tokens_aggregate`
--

DROP TABLE IF EXISTS `lv2ld_finder_tokens_aggregate`;
CREATE TABLE IF NOT EXISTS `lv2ld_finder_tokens_aggregate` (
  `term_id` int(10) UNSIGNED NOT NULL,
...
--
-- Estructura de tabla para la tabla `lv2ld_finder_types`
--

DROP TABLE IF EXISTS `lv2ld_finder_types`;
CREATE TABLE IF NOT EXISTS `lv2ld_finder_types` (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
...
--
-- Estructura de tabla para la tabla `lv2ld_languages`
--

DROP TABLE IF EXISTS `lv2ld_languages`;
CREATE TABLE IF NOT EXISTS `lv2ld_languages` (
...
--
-- Volcado de datos para la tabla `lv2ld_languages`
--

INSERT INTO `lv2ld_languages` (`lang_id`, `asset_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
(1, 0, 'en-GB', 'English (en-GB)', 'English (United Kingdom)', 'en', 'en_gb', '', '', '', '', 1, 1, 1);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `lv2ld_menu`
--

DROP TABLE IF EXISTS `lv2ld_menu`;
CREATE TABLE IF NOT EXISTS `lv2ld_menu` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Volcado de datos para la tabla `lv2ld_menu`
--

INSERT INTO `lv2ld_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`) VALUES
...
(102, 'mainmenu', 'Noticia 1', 'noticia-1', '', 'noticia-1', 'index.php?option=com_content&view=article&id=2', 'component', 1, 1, 1, 22, 0, '0000-00-00 00:00:00', 0, 1, ' ', 0, '{\"show_title\":\"\",\"link_titles\":\"\",\"show_intro\":\"\",\"info_block_position\":\"\",\"info_block_show_title\":\"\",\"show_category\":\"\",\"link_category\":\"\",\"show_parent_category\":\"\",\"link_parent_category\":\"\",\"show_associations\":\"\",\"show_author\":\"\",\"link_author\":\"\",\"show_create_date\":\"\",\"show_modify_date\":\"\",\"show_publish_date\":\"\",\"show_item_navigation\":\"\",\"show_vote\":\"\",\"show_icons\":\"\",\"show_print_icon\":\"\",\"show_email_icon\":\"\",\"show_hits\":\"\",\"show_tags\":\"\",\"show_noauth\":\"\",\"urls_position\":\"\",\"menu-anchor_title\":\"\",\"menu-anchor_css\":\"\",\"menu_image\":\"\",\"menu_image_css\":\"\",\"menu_text\":1,\"menu_show\":1,\"page_title\":\"\",\"show_page_heading\":\"\",\"page_heading\":\"\",\"pageclass_sfx\":\"\",\"menu-meta_description\":\"\",\"menu-meta_keywords\":\"\",\"robots\":\"\",\"secure\":0}', 43, 44, 0, '*', 0);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `lv2ld_menu_types`
--

DROP TABLE IF EXISTS `lv2ld_menu_types`;
CREATE TABLE IF NOT EXISTS `lv2ld_menu_types` (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `asset_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Volcado de datos para la tabla `lv2ld_menu_types`
--

INSERT INTO `lv2ld_menu_types` (`id`, `asset_id`, `menutype`, `title`, `description`, `client_id`) VALUES
(1, 0, 'mainmenu', 'Main Menu', 'The main menu for the site', 0);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `lv2ld_messages`
--

DROP TABLE IF EXISTS `lv2ld_messages`;
CREATE TABLE IF NOT EXISTS `lv2ld_messages` (
...
--
-- Estructura de tabla para la tabla `lv2ld_messages_cfg`
--

DROP TABLE IF EXISTS `lv2ld_messages_cfg`;
CREATE TABLE IF NOT EXISTS `lv2ld_messages_cfg` (
...
--
-- Estructura de tabla para la tabla `lv2ld_modules`
--

DROP TABLE IF EXISTS `lv2ld_modules`;
CREATE TABLE IF NOT EXISTS `lv2ld_modules` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `asset_id` int(10) UNSIGNED NOT NULL DEFAULT '0' COMMENT 'FK to the #__assets table.',
...
--
-- Volcado de datos para la tabla `lv2ld_modules`
--

INSERT INTO `lv2ld_modules` (`id`, `asset_id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
...
--
-- Estructura de tabla para la tabla `lv2ld_modules_menu`
--

DROP TABLE IF EXISTS `lv2ld_modules_menu`;
CREATE TABLE IF NOT EXISTS `lv2ld_modules_menu` (
...
--
-- Volcado de datos para la tabla `lv2ld_modules_menu`
--

INSERT INTO `lv2ld_modules_menu` (`moduleid`, `menuid`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
--
-- Estructura de tabla para la tabla `lv2ld_newsfeeds`
--

DROP TABLE IF EXISTS `lv2ld_newsfeeds`;
CREATE TABLE IF NOT EXISTS `lv2ld_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT '0',
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
...
--
-- Estructura de tabla para la tabla `lv2ld_overrider`
--

DROP TABLE IF EXISTS `lv2ld_overrider`;
CREATE TABLE IF NOT EXISTS `lv2ld_overrider` (
...
--
-- Estructura de tabla para la tabla `lv2ld_postinstall_messages`
--

DROP TABLE IF EXISTS `lv2ld_postinstall_messages`;
CREATE TABLE IF NOT EXISTS `lv2ld_postinstall_messages` (
...
--
-- Volcado de datos para la tabla `lv2ld_postinstall_messages`
--

INSERT INTO `lv2ld_postinstall_messages` (`postinstall_message_id`, `extension_id`, `title_key`, `description_key`, `action_key`, `language_extension`, `language_client_id`, `type`, `action_file`, `action`, `condition_file`, `condition_method`, `version_introduced`, `enabled`) VALUES
...
--
-- Estructura de tabla para la tabla `lv2ld_privacy_consents`
--

DROP TABLE IF EXISTS `lv2ld_privacy_consents`;
CREATE TABLE IF NOT EXISTS `lv2ld_privacy_consents` (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `user_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Estructura de tabla para la tabla `lv2ld_privacy_requests`
--

DROP TABLE IF EXISTS `lv2ld_privacy_requests`;
CREATE TABLE IF NOT EXISTS `lv2ld_privacy_requests` (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
...
--
-- Estructura de tabla para la tabla `lv2ld_redirect_links`
--

DROP TABLE IF EXISTS `lv2ld_redirect_links`;
CREATE TABLE IF NOT EXISTS `lv2ld_redirect_links` (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
...
--
-- Estructura de tabla para la tabla `lv2ld_schemas`
--

DROP TABLE IF EXISTS `lv2ld_schemas`;
CREATE TABLE IF NOT EXISTS `lv2ld_schemas` (
...
--
-- Volcado de datos para la tabla `lv2ld_schemas`
--

INSERT INTO `lv2ld_schemas` (`extension_id`, `version_id`) VALUES
(700, '3.9.3-2019-02-07');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `lv2ld_session`
--

DROP TABLE IF EXISTS `lv2ld_session`;
CREATE TABLE IF NOT EXISTS `lv2ld_session` (
...
--
-- Volcado de datos para la tabla `lv2ld_session`
--

INSERT INTO `lv2ld_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`) VALUES
(0x31376239627274686939673062706b386c316261363672366c36, 1, 0, 1551753596, 'joomla|s:868:\"\";', 288, 'veronica'),
(0x356c31307261323933766e69366a756275646870697538756135, 0, 1, 1551753603, 'joomla|s:736:\"\";', 0, ''),
(0x386a66623575616d31723774686a65393838656a39316d353565, 0, 0, 1551732065, 'joomla|s:948:\"\";', 288, 'veronica'),
(0x7172353239666d616461376f64613366726f387539386f706866, 1, 0, 1551732292, 'joomla|s:1872:\"\";', 288, 'veronica');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `lv2ld_tags`
--

DROP TABLE IF EXISTS `lv2ld_tags`;
CREATE TABLE IF NOT EXISTS `lv2ld_tags` (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `lft` int(11) NOT NULL DEFAULT '0',
  `rgt` int(11) NOT NULL DEFAULT '0',
...
--
-- Volcado de datos para la tabla `lv2ld_tags`
--

INSERT INTO `lv2ld_tags` (`id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `created_by_alias`, `modified_user_id`, `modified_time`, `images`, `urls`, `hits`, `language`, `version`, `publish_up`, `publish_down`) VALUES
(1, 0, 0, 1, 0, '', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '', '', '', '', 288, '2019-02-28 20:24:04', '', 0, '0000-00-00 00:00:00', '', '', 0, '*', 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `lv2ld_template_styles`
--

DROP TABLE IF EXISTS `lv2ld_template_styles`;
CREATE TABLE IF NOT EXISTS `lv2ld_template_styles` (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
...
--
-- Volcado de datos para la tabla `lv2ld_template_styles`
--

INSERT INTO `lv2ld_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `params`) VALUES
...
--
-- Estructura de tabla para la tabla `lv2ld_ucm_base`
--

DROP TABLE IF EXISTS `lv2ld_ucm_base`;
CREATE TABLE IF NOT EXISTS `lv2ld_ucm_base` (
...
--
-- Estructura de tabla para la tabla `lv2ld_ucm_content`
--

DROP TABLE IF EXISTS `lv2ld_ucm_content`;
CREATE TABLE IF NOT EXISTS `lv2ld_ucm_content` (
...
--
-- Estructura de tabla para la tabla `lv2ld_ucm_history`
--

DROP TABLE IF EXISTS `lv2ld_ucm_history`;
CREATE TABLE IF NOT EXISTS `lv2ld_ucm_history` (
...
--
-- Volcado de datos para la tabla `lv2ld_ucm_history`
--

INSERT INTO `lv2ld_ucm_history` (`version_id`, `ucm_item_id`, `ucm_type_id`, `version_note`, `save_date`, `editor_user_id`, `character_count`, `sha1_hash`, `version_data`, `keep_forever`) VALUES
(1, 1, 1, '', '2019-03-04 20:38:26', 288, 1803, '812acc7d82e2dd46633d100101a4916f61c91680', '{\"id\":1,\"asset_id\":60,\"title\":\"noticias upv\",\"alias\":\"noticias-upv\",\"introtext\":\"<p>catalogo de noticias universitarias<\\/p>\",\"fulltext\":\"\",\"state\":1,\"catid\":\"2\",\"created\":\"2019-03-04 20:38:26\",\"created_by\":\"288\",\"created_by_alias\":\"\",\"modified\":\"2019-03-04 20:38:26\",\"modified_by\":null,\"checked_out\":null,\"checked_out_time\":null,\"publish_up\":\"2019-03-04 20:38:26\",\"publish_down\":\"0000-00-00 00:00:00\",\"images\":\"{\\\"image_intro\\\":\\\"\\\",\\\"float_intro\\\":\\\"\\\",\\\"image_intro_alt\\\":\\\"\\\",\\\"image_intro_caption\\\":\\\"\\\",\\\"image_fulltext\\\":\\\"\\\",\\\"float_fulltext\\\":\\\"\\\",\\\"image_fulltext_alt\\\":\\\"\\\",\\\"image_fulltext_caption\\\":\\\"\\\"}\",\"urls\":\"{\\\"urla\\\":false,\\\"urlatext\\\":\\\"\\\",\\\"targeta\\\":\\\"\\\",\\\"urlb\\\":false,\\\"urlbtext\\\":\\\"\\\",\\\"targetb\\\":\\\"\\\",\\\"urlc\\\":false,\\\"urlctext\\\":\\\"\\\",\\\"targetc\\\":\\\"\\\"}\",\"attribs\":\"{\\\"article_layout\\\":\\\"\\\",\\\"show_title\\\":\\\"\\\",\\\"link_titles\\\":\\\"\\\",\\\"show_tags\\\":\\\"\\\",\\\"show_intro\\\":\\\"\\\",\\\"info_block_position\\\":\\\"\\\",\\\"info_block_show_title\\\":\\\"\\\",\\\"show_category\\\":\\\"\\\",\\\"link_category\\\":\\\"\\\",\\\"show_parent_category\\\":\\\"\\\",\\\"link_parent_category\\\":\\\"\\\",\\\"show_associations\\\":\\\"\\\",\\\"show_author\\\":\\\"\\\",\\\"link_author\\\":\\\"\\\",\\\"show_create_date\\\":\\\"\\\",\\\"show_modify_date\\\":\\\"\\\",\\\"show_publish_date\\\":\\\"\\\",\\\"show_item_navigation\\\":\\\"\\\",\\\"show_icons\\\":\\\"\\\",\\\"show_print_icon\\\":\\\"\\\",\\\"show_email_icon\\\":\\\"\\\",\\\"show_vote\\\":\\\"\\\",\\\"show_hits\\\":\\\"\\\",\\\"show_noauth\\\":\\\"\\\",\\\"urls_position\\\":\\\"\\\",\\\"alternative_readmore\\\":\\\"\\\",\\\"article_page_title\\\":\\\"\\\",\\\"show_publishing_options\\\":\\\"\\\",\\\"show_article_options\\\":\\\"\\\",\\\"show_urls_images_backend\\\":\\\"\\\",\\\"show_urls_images_frontend\\\":\\\"\\\"}\",\"version\":1,\"ordering\":null,\"metakey\":\"\",\"metadesc\":\"\",\"access\":\"1\",\"hits\":null,\"metadata\":\"{\\\"robots\\\":\\\"\\\",\\\"author\\\":\\\"\\\",\\\"rights\\\":\\\"\\\",\\\"xreference\\\":\\\"\\\"}\",\"featured\":\"0\",\"language\":\"*\",\"xreference\":\"\",\"note\":\"\"}', 0),
(2, 2, 1, '', '2019-03-04 20:42:12', 288, 1842, '1ccb0c625414a605a1f1ed916d54c1490d2cfc49', '{\"id\":2,\"asset_id\":61,\"title\":\"noticia 1 de la upv\",\"alias\":\"noticia-1-de-la-upv\",\"introtext\":\"<p><img src=\\\"images\\/banners\\/shop-ad-books.jpg\\\" alt=\\\"\\\" \\/><\\/p>\",\"fulltext\":\"\",\"state\":1,\"catid\":\"2\",\"created\":\"2019-03-04 20:42:12\",\"created_by\":\"288\",\"created_by_alias\":\"\",\"modified\":\"2019-03-04 20:42:12\",\"modified_by\":null,\"checked_out\":null,\"checked_out_time\":null,\"publish_up\":\"2019-03-04 20:42:12\",\"publish_down\":\"0000-00-00 00:00:00\",\"images\":\"{\\\"image_intro\\\":\\\"\\\",\\\"float_intro\\\":\\\"\\\",\\\"image_intro_alt\\\":\\\"\\\",\\\"image_intro_caption\\\":\\\"\\\",\\\"image_fulltext\\\":\\\"\\\",\\\"float_fulltext\\\":\\\"\\\",\\\"image_fulltext_alt\\\":\\\"\\\",\\\"image_fulltext_caption\\\":\\\"\\\"}\",\"urls\":\"{\\\"urla\\\":false,\\\"urlatext\\\":\\\"\\\",\\\"targeta\\\":\\\"\\\",\\\"urlb\\\":false,\\\"urlbtext\\\":\\\"\\\",\\\"targetb\\\":\\\"\\\",\\\"urlc\\\":false,\\\"urlctext\\\":\\\"\\\",\\\"targetc\\\":\\\"\\\"}\",\"attribs\":\"{\\\"article_layout\\\":\\\"\\\",\\\"show_title\\\":\\\"\\\",\\\"link_titles\\\":\\\"\\\",\\\"show_tags\\\":\\\"\\\",\\\"show_intro\\\":\\\"\\\",\\\"info_block_position\\\":\\\"\\\",\\\"info_block_show_title\\\":\\\"\\\",\\\"show_category\\\":\\\"\\\",\\\"link_category\\\":\\\"\\\",\\\"show_parent_category\\\":\\\"\\\",\\\"link_parent_category\\\":\\\"\\\",\\\"show_associations\\\":\\\"\\\",\\\"show_author\\\":\\\"\\\",\\\"link_author\\\":\\\"\\\",\\\"show_create_date\\\":\\\"\\\",\\\"show_modify_date\\\":\\\"\\\",\\\"show_publish_date\\\":\\\"\\\",\\\"show_item_navigation\\\":\\\"\\\",\\\"show_icons\\\":\\\"\\\",\\\"show_print_icon\\\":\\\"\\\",\\\"show_email_icon\\\":\\\"\\\",\\\"show_vote\\\":\\\"\\\",\\\"show_hits\\\":\\\"\\\",\\\"show_noauth\\\":\\\"\\\",\\\"urls_position\\\":\\\"\\\",\\\"alternative_readmore\\\":\\\"\\\",\\\"article_page_title\\\":\\\"\\\",\\\"show_publishing_options\\\":\\\"\\\",\\\"show_article_options\\\":\\\"\\\",\\\"show_urls_images_backend\\\":\\\"\\\",\\\"show_urls_images_frontend\\\":\\\"\\\"}\",\"version\":1,\"ordering\":null,\"metakey\":\"\",\"metadesc\":\"\",\"access\":\"1\",\"hits\":null,\"metadata\":\"{\\\"robots\\\":\\\"\\\",\\\"author\\\":\\\"\\\",\\\"rights\\\":\\\"\\\",\\\"xreference\\\":\\\"\\\"}\",\"featured\":\"0\",\"language\":\"*\",\"xreference\":\"\",\"note\":\"\"}', 0);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `lv2ld_updates`
--

DROP TABLE IF EXISTS `lv2ld_updates`;
CREATE TABLE IF NOT EXISTS `lv2ld_updates` (
...
--
-- Volcado de datos para la tabla `lv2ld_updates`
--

INSERT INTO `lv2ld_updates` (`update_id`, `update_site_id`, `extension_id`, `name`, `description`, `element`, `type`, `folder`, `client_id`, `version`, `data`, `detailsurl`, `infourl`, `extra_query`) VALUES
...
--
-- Estructura de tabla para la tabla `lv2ld_update_sites`
--

DROP TABLE IF EXISTS `lv2ld_update_sites`;
CREATE TABLE IF NOT EXISTS `lv2ld_update_sites` (
...
--
-- Volcado de datos para la tabla `lv2ld_update_sites`
--

INSERT INTO `lv2ld_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`, `extra_query`) VALUES
(1, 'Joomla! Core', 'collection', 'https://update.joomla.org/core/list.xml', 1, 1551753594, ''),
(2, 'Accredited Joomla! Translations', 'collection', 'https://update.joomla.org/language/translationlist_3.xml', 1, 1551753595, ''),
(3, 'Joomla! Update Component Update Site', 'extension', 'https://update.joomla.org/core/extensions/com_joomlaupdate.xml', 1, 1551753596, '');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `lv2ld_update_sites_extensions`
--

DROP TABLE IF EXISTS `lv2ld_update_sites_extensions`;
CREATE TABLE IF NOT EXISTS `lv2ld_update_sites_extensions` (
...
--
-- Volcado de datos para la tabla `lv2ld_update_sites_extensions`
--

INSERT INTO `lv2ld_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
(1, 700),
(2, 802),
(3, 28);
...
--
-- Estructura de tabla para la tabla `lv2ld_usergroups`
--

DROP TABLE IF EXISTS `lv2ld_usergroups`;
CREATE TABLE IF NOT EXISTS `lv2ld_usergroups` (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
...
--
-- Volcado de datos para la tabla `lv2ld_usergroups`
--

INSERT INTO `lv2ld_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 18, 'Public'),
(2, 1, 8, 15, 'Registered'),
(3, 2, 9, 14, 'Author'),
(4, 3, 10, 13, 'Editor'),
...
--
-- Estructura de tabla para la tabla `lv2ld_users`
--

DROP TABLE IF EXISTS `lv2ld_users`;
CREATE TABLE IF NOT EXISTS `lv2ld_users` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Volcado de datos para la tabla `lv2ld_users`
--

INSERT INTO `lv2ld_users` (`id`, `name`, `username`, `email`, `password`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`, `otpKey`, `otep`, `requireReset`) VALUES
(288, 'Super User', 'veronica', 'zunigaaguilarveronicaisabel@gmail.com', '$2y$10$rjt8dLW1Zh5mcwtQStngEuXIQRVPG4VuKN1K5hjbY/yo1NlQg83P6', 0, 1, '2019-02-28 20:24:05', '2019-03-05 02:39:45', '0', '', '0000-00-00 00:00:00', 0, '', '', 0);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `lv2ld_user_keys`
--

DROP TABLE IF EXISTS `lv2ld_user_keys`;
CREATE TABLE IF NOT EXISTS `lv2ld_user_keys` (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
...
--
-- Estructura de tabla para la tabla `lv2ld_user_notes`
--

DROP TABLE IF EXISTS `lv2ld_user_notes`;
CREATE TABLE IF NOT EXISTS `lv2ld_user_notes` (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `user_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `catid` int(10) UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Estructura de tabla para la tabla `lv2ld_user_profiles`
--

DROP TABLE IF EXISTS `lv2ld_user_profiles`;
CREATE TABLE IF NOT EXISTS `lv2ld_user_profiles` (
...
--
-- Estructura de tabla para la tabla `lv2ld_user_usergroup_map`
--

DROP TABLE IF EXISTS `lv2ld_user_usergroup_map`;
CREATE TABLE IF NOT EXISTS `lv2ld_user_usergroup_map` (
...
--
-- Volcado de datos para la tabla `lv2ld_user_usergroup_map`
--

INSERT INTO `lv2ld_user_usergroup_map` (`user_id`, `group_id`) VALUES
(288, 8);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `lv2ld_utf8_conversion`
--

DROP TABLE IF EXISTS `lv2ld_utf8_conversion`;
CREATE TABLE IF NOT EXISTS `lv2ld_utf8_conversion` (
  `converted` tinyint(4) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Volcado de datos para la tabla `lv2ld_utf8_conversion`
--

INSERT INTO `lv2ld_utf8_conversion` (`converted`) VALUES
(2);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `lv2ld_viewlevels`
--

DROP TABLE IF EXISTS `lv2ld_viewlevels`;
CREATE TABLE IF NOT EXISTS `lv2ld_viewlevels` (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
  `title` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT '0',
  `rules` varchar(5120) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'JSON encoded access control.',
...
--
-- Volcado de datos para la tabla `lv2ld_viewlevels`
--

INSERT INTO `lv2ld_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Public', 0, '[1]'),
